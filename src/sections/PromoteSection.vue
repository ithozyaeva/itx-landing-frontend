      ...
      <div class="grid gap-4 px-4 sm:px-6 md:px-10 md:grid-cols-2 md:gap-16">
        ...
        >
          <div class="space-y-2">
            ...
            >
              Станьте хозяином своего пути в IT
            </h1>
            <p class="max-w-[600px] text-muted-foreground md:text-xl">
              Получайте поддержку экспертов, доступ к закрытым материалам и сильному окружению,
              чтобы системно развивать навыки, создавать проекты и уверенно двигаться к своим целям — от саморазвития до карьеры
            </p>
          </div>
          <div
