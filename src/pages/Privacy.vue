    ...
    <ul class="space-y-5">
      <li class="space-y-[8px]">
        <Typography
          ...
          as="h2"
          typography-type="text"
          class="text-accent mb-3 md:mb-4 mt-6 md:mt-8"
        >
          1. Общие положения
        </Typography>
        <Typography
        ...
        >
          ...
          обработки
          персональных данных и меры по обеспечению безопасности персональных данных, предпринимаемые Стародубцевым
          Александром Владимировичем (далее — Оператор).
        </Typography>
        <ul class="space-y-[8px]">
          ...
          >
            ...
            ко всей
            информации, которую Оператор может получить о посетителях веб-сайта <Typography
              href="https://ithozyaeva.ru/"
              as="a"
              variant="body-l"
              class="text-accent"
              data-typography="text"
      ...
      >
        ...
        <ul class="space-y-[8px]">
          ...
          >
            ...
            обеспечивающих их доступность в сети интернет по сетевому адресу <Typography
              href="https://ithozyaeva.ru/"
              as="a"
              variant="body-l"
              class="text-accent"
          ...
          >
            ...
            Пользователю веб-сайта <Typography
              href="https://ithozyaeva.ru/"
              as="a"
              variant="body-l"
              class="text-accent"
          ...
          <Typography
            ...
            data-typography="text"
          >
            2.10. Пользователь — любой посетитель веб-сайта <Typography
              href="https://ithozyaeva.ru/"
              as="a"
              variant="body-l"
              class="text-accent"
      ...
      >
        ...
        <ul class="space-y-[8px]">
          ...
          >
            3.2. Оператор обязан:
            <ul class="list-disc px-5 space-y-[8px]">
              <Typography
                variant="body-l"
                as="li"
                data-typography="text"
      ...
      >
        ...
        <ul class="space-y-[8px]">
          ...
          <Typography
            ...
            data-typography="text"
          >
            4.3. Лица, передавшие Оператору недостоверные сведения... несут ответственность в соответствии с
      ...
      >
        ...
        <ul class="space-y-[8px]">
          ...
          >
            ...
            принимает необходимые меры и/или обеспечивает их принятие по удалению или уточнению неполных или неточных
            данных.
          </Typography>
          <Typography
            variant="body-l"
      ...
      >
        ...
        <ul class="space-y-[8px]">
          ...
          <Typography
            ...
            data-typography="text"
          >
            8.3. В случае выявления неточностей в персональных данных, Пользователь может актуализировать их самостоятельно, путем направления Оператору уведомление на адрес электронной почты Оператора <Typography
              href="mailto:jointime.alex@yandex.ru"
              as="a"
              variant="body-l"
              class="text-accent"
              data-typography="text"
            >
              jointime.alex@yandex.ru
            </Typography> с пометкой «Актуализация персональных данных».
          </Typography>
          <Typography
            variant="body-l"
            as="li"
          ...
          >
            ...
            Пользователь может в любой момент отозвать свое согласие на обработку персональных данных, направив Оператору уведомление посредством электронной почты на электронный адрес Оператора <Typography
              href="mailto:jointime.alex@yandex.ru"
              as="a"
              variant="body-l"
              class="text-accent"
            ...
            >
              jointime.alex@yandex.ru
            </Typography> с пометкой «Отзыв согласия на обработку персональных данных».
          </Typography>
          <Typography
            variant="body-l"
            as="li"
      ...
      >
        ...
        <ul class="space-y-[8px]">
          <Typography
            ...
            data-typography="text"
          >
            Оператор и иные лица не вправе раскрывать или распространять персональные данные без согласия субъекта.
          </Typography>
        </ul>
      </Typography>
      ...
      >
        ...
        <ul class="space-y-[8px]">
          <Typography
            ...
            data-typography="text"
          >
            12.1. Пользователь может получить любые разъяснения по интересующим вопросам, касающимся обработки его персональных данных, обратившись к Оператору с помощью электронной почты <Typography
              href="mailto:jointime.alex@yandex.ru"
              as="a"
              variant="body-l"
              class="text-accent"
          ...
          <Typography
            ...
            data-typography="text"
          >
            12.3. Актуальная версия Политики в свободном доступе расположена в сети Интернет по адресу <Typography
              href="https://ithozyaeva.ru/privacy"
              as="a"
              variant="body-l"
              class="text-accent"
              data-typography="text"
            >
              https://ithozyaeva.ru/privacy
            </Typography>.
          </Typography>
        </ul>
      </Typography>
